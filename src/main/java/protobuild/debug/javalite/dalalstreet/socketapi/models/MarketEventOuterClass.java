...
public final class MarketEventOuterClass {
  ...
  public interface MarketEventOrBuilder extends
      // @@protoc_insertion_point(interface_extends:dalalstreet.socketapi.models.MarketEvent)
  ...
  /**
   * Protobuf type {@code dalalstreet.socketapi.models.MarketEvent}
   */
  ...
  checkByteStringIsUtf8(value);
    ...
    public static dalalstreet.socketapi.models.MarketEventOuterClass.MarketEvent parseFrom(
    ...
    public static dalalstreet.socketapi.models.MarketEventOuterClass.MarketEvent parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
          DEFAULT_INSTANCE, data);
    }
    ...
    public static dalalstreet.socketapi.models.MarketEventOuterClass.MarketEvent parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageLite.parseFrom(
    ...
    public static dalalstreet.socketapi.models.MarketEventOuterClass.MarketEvent parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return parseDelimitedFrom(DEFAULT_INSTANCE, input);
    }
    public static dalalstreet.socketapi.models.MarketEventOuterClass.MarketEvent parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
    ...
    public static Builder newBuilder(dalalstreet.socketapi.models.MarketEventOuterClass.MarketEvent prototype) {
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          dalalstreet.socketapi.models.MarketEventOuterClass.MarketEvent, Builder> implements
        // @@protoc_insertion_point(builder_implements:dalalstreet.socketapi.models.MarketEvent)
        dalalstreet.socketapi.models.MarketEventOuterClass.MarketEventOrBuilder {
      // Construct using dalalstreet.socketapi.models.MarketEventOuterClass.MarketEvent.newBuilder()
      private Builder() {
      ...
      // @@protoc_insertion_point(builder_scope:dalalstreet.socketapi.models.MarketEvent)
    }
    protected final Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new dalalstreet.socketapi.models.MarketEventOuterClass.MarketEvent();
        }
        case IS_INITIALIZED: {
        ...
        case VISIT: {
          ...
          dalalstreet.socketapi.models.MarketEventOuterClass.MarketEvent other = (dalalstreet.socketapi.models.MarketEventOuterClass.MarketEvent) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (dalalstreet.socketapi.models.MarketEventOuterClass.MarketEvent.class) {
              if (PARSER == null) {
    ...
    // @@protoc_insertion_point(class_scope:dalalstreet.socketapi.models.MarketEvent)
    private static final dalalstreet.socketapi.models.MarketEventOuterClass.MarketEvent DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new MarketEvent();
      DEFAULT_INSTANCE.makeImmutable();
    }

    public static dalalstreet.socketapi.models.MarketEventOuterClass.MarketEvent getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
